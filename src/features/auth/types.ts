 ...
 *   3. Premium          — €19.99/mo (€199/yr), full individual experience
 *   4. Architect         — €49.99/mo (€499/yr), professional tools + team collaboration
 *   5. Constructor       — €149.90/mo (€1499/yr), enterprise: unlimited, white-label, API
 *
...
export const ACCOUNT_TIERS: AccountTierConfig[] = [
  ...
  /* ── 3. Premium — €19.99/month ── */
  {
    ...
    priceMonthly: 19.99,
    priceYearly: 199, // ~17% savings (2 months free)
    color: "#F59E0B",
    features: {
      maxTerrainSize: 5000,
