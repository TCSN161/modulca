  ...
  return (
    <div className="w-full max-w-md rounded-xl bg-white p-8 shadow-sm">
      <h1 className="mb-1 text-2xl font-bold text-brand-teal-800">
        {isLogin ? tSignIn("welcomeBack") : tSignUp("heading")}
      </h1>
      <p className="mb-6 text-sm text-gray-500">
        {isLogin ? tSignIn("subtitle") : tSignUp("subtitle")}
      </p>
      ...
      <div className="mb-4 flex items-center gap-3">
        ...
        <span className="text-xs text-gray-400">{tSignIn("or")}</span>
        <div className="h-px flex-1 bg-gray-200" />
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-3">
        ...
        <div>
          ...
          <input
            ...
            required
            minLength={6}
            placeholder={isLogin ? tSignIn("passwordPlaceholder") : tSignUp("passwordPlaceholder")}
            className="w-full rounded-lg border border-gray-200 px-3 py-2.5 text-sm outline-none transition-colors focus:border-brand-teal-500 focus:ring-1 focus:ring-brand-teal-500"
          />
        </div>
        ...
        >
          {loading ? tSignIn("submitting") : isLogin ? tSignIn("submit") : tSignUp("submit")}
        </button>
      </form>
